...
class CompanyActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 Company records ordered by the id field
...
class CategoryActions(Generic[_PrismaModelT]):
            ...
            data=[
                {
                    # data to create a Category record
                    'name': 'bbejhfidcb',
                    'companyId': 1644289366,
                },
                {
                    # data to create a Category record
                    'name': 'bdiicjafbj',
                    'companyId': 1647418052,
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def find_many(
        ...
        # find the first 5 Category records ordered by the companyId field
...
class ProductActions(Generic[_PrismaModelT]):
    ...
    async def create(
        ...
        product = await Product.prisma().create(
            data={
                ...
                'name': 'igbehcbab',
                'price': 1303003706.168663,
                'companyId': 2000430152,
            ...
            data=[
                {
                    # data to create a Product record
                    'name': 'bigaiehgcc',
                    'price': 1448521415.162865,
                    'companyId': 1249606685,
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Product records by id values
        # and count how many records are in each group
